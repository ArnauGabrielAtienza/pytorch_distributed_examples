...
1. Model Parallelism: The ResNet50 layers are split between two workers.

To run the script across multiple nodes, modify the main script with the
correct IP and Ports. The script also needs to be modified to only launch
one of the two processes on the given node.
"""
...
def run_worker(rank, world_size, num_split):
    ...
    options = rpc.TensorPipeRpcBackendOptions(num_worker_threads=16, rpc_timeout=300)
